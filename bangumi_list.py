...
def push(data, pageInfo, urlInfo):
    ...
    # 整理数据
        bangumiData = {
            "id": bangumiId,
            "alistPath": alistPath,
            "bgmUrl": data['myMainPost']['BANGUMI_URL'],
            "img": data['myMainPost']['BANGUMI_IMG'],
            "name": data['myMainPost']['BANGUMI_NAME'],
            "chineseName": data['myMainPost']['BANGUMI_CHINESE'],
            "episode": data['myMainPost']['BANGUMI_EPISODE'],
