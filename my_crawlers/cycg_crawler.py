...
def get_mainpost_data(postSoup, threadData):
    ...
    if quote_div:
        ...
        if blockquote: # 删除所有子标签，保留文字和br标签（内容可能在br标签内）
            ...
            replyStr = re.sub(r'(\s*(<br>|<br/>|</br>)\s*)+', '<br/>', replyStr)
            # 最后添加引用标签
    ...
    # 保存到myMainPost
    myMainPost['POST_CONTENT_P'] = content


    # # 打印获取到内容
    # import pprint  
    # # print(myMainPost)
    # pprint.pprint(myMainPost)
